...
```{r PCA contribution of variables}
...
```{r Stomatal density and minimal conductance}
...
```{r Individuals per species collected in the three sampling sites. }
